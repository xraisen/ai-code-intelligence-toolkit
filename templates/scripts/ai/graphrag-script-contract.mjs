export const AI_INTELLIGENCE_REQUIRED_SCRIPT_NAMES = Object.freeze([
  "ai:spec",
  "ai:preflight",
  "ai:graph:build",
  "ai:graph:build:fast",
  "ai:graph:build:minimal",
  "ai:graph:build:full",
  "ai:graph:query",
  "ai:graph:doctor",
  "ai:graph:check-leaks",
  "ai:graph:health",
  "mcp:code-intel",
  "typedoc:config:auto",
  "typedoc:config:local",
  "typedoc:config:github",
  "typedoc:json",
  "typedoc:json:auto",
  "typedoc:json:local",
  "typedoc:json:github",
...
export const AI_INTELLIGENCE_REQUIRED_FILES = Object.freeze({
  agents: "AGENTS.md",
  readme: "README.md",
  groundTruth: "AI_GROUND_TRUTH.md",
  symbolIndex: "AI_SYMBOL_INDEX.json",
  graphBuilder: "scripts/graphrag/build-code-graph.mjs",
  graphQuery: "scripts/graphrag/query-code-graph.mjs",
  graphDoctor: "scripts/graphrag/doctor.mjs",
  graphLeakCheck: "scripts/graphrag/check-no-leaks.mjs",
  specPreflight: "scripts/ai/spec-preflight.mjs",
  codexPreflight: "scripts/ai/codex-preflight.mjs",
  scriptContract: "scripts/ai/graphrag-script-contract.mjs",
  typedocSourceConfig: "scripts/typedoc-source-config.mjs",
  typedocSourceLinkDoctor: "scripts/typedoc-source-link-doctor.mjs",
  typedocToolHealth: "scripts/typedoc-tool-health.mjs",
  typedocLocalCheck: "scripts/ai/typedoc-local-source-check.mjs"
});

export const DEFAULT_SCRIPT_MAP = Object.freeze({
